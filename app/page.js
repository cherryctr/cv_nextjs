  ...
  return (
    <>
      <motion.div
        ...
        className="bg-white relative dark:bg-[#212121] shadow-md rounded-xl max-w-xl lg:mx-auto mx-4 lg:max-w-xl  max-2xl  md:mx-auto sm:mx-auto lg:px-0 "
      >
        ...
        <div className="mt-24 p-2">
          ...
          <div className="bg-[#F6F8FA] p-6 dark:bg-[#2C2C2C] mt-14 endsection-margin">
